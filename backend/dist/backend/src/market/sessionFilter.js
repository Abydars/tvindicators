...
class SessionFilter {
     ...
     */
    static isInPakistanSession(timestamp) {
        const tz = config_1.config.sessionTimezone;
        const dt = luxon_1.DateTime.fromMillis(timestamp).setZone(tz);
     ...
     */
    static didSessionJustEnd(previousTimestamp, currentTimestamp) {
